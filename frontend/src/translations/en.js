export const en = {
    ...
    immigration: {
      ...
      services: {
        visas: {
          ...
          description: 'Assistance with various visa types including work, student, and family visas.'
        },
        greenCard: {
    ...
    legalRights: {
      ...
      sections: {
        ...
        housing: {
          ...
          description: 'Learn about tenant rights, fair housing laws, and protections against discrimination.'
        },
        employment: {
          title: 'Employment Rights',
          description: 'Information about workplace rights, fair labor standards, and anti-discrimination laws.'
        }
      }
    },
    legalChat: {
    ...
    security: {
      ...
      subtitle: 'Your privacy and security are our top priorities. We implement industry-leading security measures to protect your data.',
      features: {
        encryption: {
        ...
        audits: {
          ...
          description: 'We conduct regular security assessments and penetration testing to ensure your data is protected.'
        },
        dataProtection: {
          title: 'Data Protection',
          description: 'Your data is protected according to the highest industry standards and compliance requirements.'
        },
        compliance: {
      ...
      updateMessage: 'We regularly update our security measures and compliance certifications to ensure the highest level of protection for your data.'
    },
    subscription: {
